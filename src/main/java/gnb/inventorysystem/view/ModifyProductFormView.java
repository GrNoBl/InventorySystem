...
/**
 * The controller for interacting with the "Modify Product" form.
...
public class ModifyProductFormView implements Initializable {
    ...
    /**
     * When initialized, associates first table with available parts.
     * Associates second table with selected products contained parts.
     */
    @Override
